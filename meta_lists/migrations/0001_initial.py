...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='symptoms',
            index=models.Index(fields=['id', 'name', 'display_index'], name='meta_lists__id_f12990_idx'),
        ),
        migrations.AddIndex(
            model_name='offstudyreasons',
            index=models.Index(fields=['id', 'name', 'display_index'], name='meta_lists__id_d6cb87_idx'),
        ),
        migrations.AddIndex(
            model_name='arvregimens',
            index=models.Index(fields=['id', 'name', 'display_index'], name='meta_lists__id_10dc52_idx'),
        ),
    ]
